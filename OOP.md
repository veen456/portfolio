...
> Click on the buttons bellow to learn about object oriented programming


<div style="display: flex; flex-wrap: wrap; gap: 10px;">
    <a href="{{site.baseurl}}/writing_classes" style="text-decoration: none;">
    ...
    <a href="{{site.baseurl}}/inheritence" style="text-decoration: none;">
