...
<div style="display: flex; flex-wrap: wrap; gap: 10px;">
    <a href="{{site.baseurl}}/mathematical" style="text-decoration: none;">
    ...
    <a href="{{site.baseurl}}/string_operations" style="text-decoration: none;">
    ...
    <a href="{{site.baseurl}}/boolean_expressions" style="text-decoration: none;">
