...
<div style="display: flex; flex-wrap: wrap; gap: 10px;">
    <a href="{{site.baseurl}}/gameplay_testing" style="text-decoration: none;">
    ...
    <a href="{{site.baseurl}}/integration_testing" style="text-decoration: none;">
    ...
    <a href="{{site.baseurl}}/api_error_handling" style="text-decoration: none;">
